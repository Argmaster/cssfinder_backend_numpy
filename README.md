...
```
Installing the current project: cssfinder_backend_numpy (0.1.0)
```
...
```
pip install ./dist/cssfinder_backend_numpy-0.1.0
```

What you expect is

```
Successfully installed cssfinder_backend_numpy-0.1.0
```
...
But `cssfinder_backend_numpy-0.1.0` should be included in this list.
